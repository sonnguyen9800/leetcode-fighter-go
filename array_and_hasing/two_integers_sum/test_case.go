...
var testCases = []TwoIntegersSumTestCase{
	...
	{Input: TwoIntergersInput{ArrayInt: []int{1, 1, 1, 1}, Target: 2}, Expected: [2]int{0, 1}},
	{Input: TwoIntergersInput{ArrayInt: []int{0, 0, 0, 0}, Target: 0}, Expected: [2]int{0, 1}},
	{Input: TwoIntergersInput{ArrayInt: []int{0, 5, 5, 0}, Target: 10}, Expected: [2]int{1, 2}},
	{Input: TwoIntergersInput{ArrayInt: []int{1, 4, 4, 1}, Target: 5}, Expected: [2]int{0, 1}},
	...
	{Input: TwoIntergersInput{ArrayInt: []int{9, 1, 8, 1}, Target: 10}, Expected: [2]int{0, 1}},
